...
export const entries = [
  ...
  { version: "0.1.40", date: "2026-05-26", type: "major", title: "Desktop-first direction confirmed", body: "Sténtor is being developed as a desktop app for theatre work.", changes: { new: [ { title: "Cross-platform direction", body: "The target is a desktop-first tool for macOS and Windows." } ] } },
