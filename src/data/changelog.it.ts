...
export const entries = [
  ...
  { version: "0.1.40", date: "2026-05-26", type: "major", title: "Direzione desktop-first", body: "Sténtor viene sviluppato come app desktop per il lavoro teatrale.", changes: { new: [{ title: "Direzione multipiattaforma", body: "Obiettivo desktop-first per macOS e Windows." }] } },
