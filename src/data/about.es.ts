...
export const about = {
  ...
  story: {
    ...
    paragraphs: [
      ...
      "El nombre remite a Esténtor en la mitología griega: no como imagen de combate, sino como la figura recordada por una voz de bronce. Sténtor transforma esa imagen en una herramienta teatral: no un sonido más fuerte, sino una transmisión más clara de palabras, lenguas y descripciones.",
