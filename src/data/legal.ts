export const privacy = {
  ...
  effectiveDate: "Effective June 5, 2026",
  ...
  sections: [
    ...
    { id: "data", title: "2. Information we may receive", body: '<p>We may receive contact details, messages, feedback, questionnaire answers, audience comments, technical notes, field notes and basic website or diagnostic information. Please avoid sending sensitive personal information unless it is necessary.</p>' },
    ...
    { id: "cookies", title: "7. Cookies and analytics", body: '<p>The website may use essential technical cookies or limited analytics configured to minimise personal data collection. We do not use third-party advertising trackers.</p>' },
...
export const terms = {
  ...
  contact: { title: "Questions?", body: 'Questions? Email <a href="mailto:info@stentor.live">info@stentor.live</a> or write to Leonardo Mancini, c/o Department of Humanities, University of Turin, Via Sant\'Ottavio 20 – 10124, Turin, Italy.' }
};
