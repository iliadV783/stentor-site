...
export const hero = {
  ...
  description:
    "Stentor e un ecosistema per il testo nello spettacolo dal vivo: una app Lite gratuita e multipiattaforma per iniziare, e una app Pro professionale pensata per macOS, Windows e Linux.",
  ctas: [
...
export const metrics = {
  ...
  description:
    "Stentor organizza il testo di scena dalla preparazione alla regia live, distinguendo un ingresso gratuito multipiattaforma da un flusso professionale destinato alle principali piattaforme desktop.",
  items: [
...
export const testimonials = {
  ...
  description:
    "Stentor si sviluppa con chi lo usa: artiste, operatori, traduttrici, teatri e pubblico. Lite mantiene l'accesso aperto; Pro cresce attraverso beta test in contesti reali e non sara limitato a un solo sistema operativo.",
  quotes: [
...
const proFeatures = ["App desktop professionale", "Prevista per macOS, Windows e Linux", "Timeline, cueing e vista regia live", "Schermi e telefoni del pubblico", "Audio descrizione e strumenti di accessibilita", "Licenza beta privata e attivazione"];
