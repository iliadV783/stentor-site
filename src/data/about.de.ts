...
export const about = {
  hero: {
    ...
    title:
      'Live-Performance braucht <em class="not-italic text-red-500">lebendige Worte</em>.<br/>Für jedes Publikum.',
    description:
